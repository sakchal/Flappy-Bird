...
OFILES = gba.o font.o main.o images/garbage.o images/background.o images/flappybird.o images/lose_screen.o images/start_img.o images/tunnel.o images/win_img.o images/enemy.o
